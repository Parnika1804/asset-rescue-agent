...
if not st.session_state["logged_in"]:
    ...
    st.markdown("""
    <style>
    /* centre the auth card and constrain its width */
    [data-testid="stVerticalBlock"] > [data-testid="stVerticalBlockBorderWrapper"] {
        max-width: 460px;
        margin: 0 auto;
    }
    /* pill active tab on login/signup switcher */
    ...
    st.markdown("""
<div class="ara-auth-header">
  <div class="ara-auth-icon">🏛️</div>
  <h1 class="ara-auth-title">AI Asset Rescue Agent</h1>
  <p class="ara-auth-sub">University Asset Management &nbsp;·&nbsp; Secure Access</p>
</div>
""", unsafe_allow_html=True)
